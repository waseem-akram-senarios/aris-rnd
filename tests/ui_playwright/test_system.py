...
class TestSystemTab:
    ...
    def test_system_tab_has_buttons(self, mcp_page: Page):
        """System tab shows stats, health, and sync buttons."""
        click_tab(mcp_page, "System")
        for label in ["Load System Stats", "Service Health", "Force Sync"]:
    ...
    def test_load_system_stats(self, mcp_page: Page):
        ...
        # Should show stats or full JSON
    ...
    def test_service_health_button(self, mcp_page: Page):
        """Clicking Service Health shows health JSON."""
        click_tab(mcp_page, "System")
        click_button(mcp_page, "Service Health")
        mcp_page.wait_for_timeout(3000)
