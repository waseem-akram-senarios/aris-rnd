...
app.include_router(focused_router, tags=["Focused API"])
...
async def query_images(
    ...
    if not vector_store_type or vector_store_type.lower() != 'opensearch':
        return ImageQueryResponse(
            ...
            images_index="aris-rag-images-index",
            message="Image queries require OpenSearch vector store. Please configure OpenSearch or upload documents with images."
        )
